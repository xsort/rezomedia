...
define('NO_PHOTO',"images/admin/no_photo.jpg");
...
define('CACHE_DIR_NAME',		'/uploaded/cache/');
...
if ($image == "/uploaded_files/"){ $image = NO_PHOTO;}
...
$offsetX	= 0;
$offsetY	= 0;
$getcropratio = $_GET['cropratio'];
if (isset($getcropratio))
{
	$cropRatio		= explode(':', (string) $getcropratio);
